...
""")
	...
	os.system("docker commit {0}{1}".format(which_cont,own_image))	
	x=input("Enter to continue...")
...
""")
	...
	os.system("docker rmi {}".format(rem_image))
...
""")
	...
	os.system("docker volume rm {}".format(rem_vol))
...
""")
	...
	jen_name=input('\nContainer Name : ')
	img_name = input('Enter image name with version. for ex- centos:7 : ')
	os.system("docker run -dit --name {} {}".format(jen_name,img_name))
